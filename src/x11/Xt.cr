module X11
  @[Link("Xt")]
  lib Xt
    # Below generated by crystal-lib, with some corrections
    ...
    fun manage_children = XtManageChildren(
      x0 : WidgetList, 
      x1 : Cardinal
    )
    ...
    alias ArgList = Arg*
    alias Arg = X_CoreClassPartInitialize
   ...
   struct XGravityEvent
    ...
    fun change_managed_set = XtChangeManagedSet(
      x0 : WidgetList, 
      x1 : Cardinal, 
      x2 : DoChangeProc, 
      x3 : Pointer, 
    ...
    fun convert_and_store = XtConvertAndStore(
      x0 : Widget, 
      x1 : LibC::Char*, 
      x2 : XrmValue*, 
      x3 : LibC::Char*, 
    ...
    fun call_converter = XtCallConverter(
      x0 : Display, 
      x1 : TypeConverter, 
      x2 : XrmValuePtr, 
      x3 : Cardinal, 
    ...
    fun own_selection = XtOwnSelection(
      x0 : Widget, 
      x1 : Atom, 
      x2 : Time, 
      x3 : ConvertSelectionProc, 
      x4 : LoseSelectionProc, 
      x5 : SelectionDoneProc
    ) : Boolean

    alias ConvertSelectionProc = (
      Widget, 
      Atom*, 
      Atom*, 
      Atom*, 
    ...
    fun own_selection_incremental = XtOwnSelectionIncremental(
      x0 : Widget, 
      x1 : Atom, 
      x2 : Time, 
      x3 : ConvertSelectionIncrProc, 
      x4 : LoseSelectionIncrProc, 
      x5 : SelectionDoneIncrProc, 
      x6 : CancelConvertSelectionProc, 
      x7 : Pointer
    ) : Boolean

    alias RequestId = Pointer

    alias ConvertSelectionIncrProc = (
      Widget, 
      Atom*, 
      Atom*, 
      Atom*, 
    ...
    fun translate_coords = XtTranslateCoords(
      x0 : Widget, 
      x1 : Position, 
      x2 : Position, 
      x3 : Position*, 
    ...
    fun get_keysym_table = XtGetKeysymTable(
      x0 : Display, 
      x1 : KeyCode*, 
      x2 : LibC::Int*
    ) : KeySym*
    ...
    fun keysym_to_keycode_list = XtKeysymToKeycodeList(
      x0 : Display, 
      x1 : KeySym, 
      x2 : KeyCode**, 
      x3 : Cardinal*
    ...
    fun string_conversion_warning = XtStringConversionWarning(
      x0 : LibC::Char*, 
      x1 : LibC::Char*
    )

    fun display_string_conversion_warning = XtDisplayStringConversionWarning(
      x0 : Display, 
      x1 : LibC::Char*, 
      x2 : LibC::Char*
    )

    fun app_add_converter = XtAppAddConverter(
      x0 : AppContext, 
      x1 : LibC::Char*, 
      x2 : LibC::Char*, 
      x3 : Converter, 
    ...
    fun add_converter = XtAddConverter(
      x0 : LibC::Char*, 
      x1 : LibC::Char*, 
      x2 : Converter, 
      x3 : ConvertArgList, 
    ...
    fun set_type_converter = XtSetTypeConverter(
      x0 : LibC::Char*, 
      x1 : LibC::Char*, 
      x2 : TypeConverter, 
      x3 : ConvertArgList, 
    ...
    fun direct_convert = XtDirectConvert(
      x0 : Converter, 
      x1 : XrmValuePtr, 
      x2 : Cardinal, 
      x3 : XrmValuePtr, 
    ...
    fun parse_translation_table = XtParseTranslationTable(
      x0 : LibC::Char*
    ) : Translations

    fun parse_accelerator_table = XtParseAcceleratorTable(
      x0 : LibC::Char*
    ) : Accelerators

    alias Accelerators = X_TranslationData*

    fun override_translations = XtOverrideTranslations(
      x0 : Widget, 
      x1 : Translations
    )

    fun augment_translations = XtAugmentTranslations(
      x0 : Widget, 
      x1 : Translations
    )
    ...
    fun install_all_accelerators = XtInstallAllAccelerators(
      x0 : Widget, 
      x1 : Widget
    )
    ...
    fun app_add_actions = XtAppAddActions(
      x0 : AppContext, 
      x1 : ActionList, 
      x2 : Cardinal
    )
    ...
    fun app_add_action_hook = XtAppAddActionHook(
      x0 : AppContext, 
      x1 : ActionHookProc, 
      x2 : Pointer
    ) : ActionHookId
    ...
    fun get_action_list = XtGetActionList(
      x0 : WidgetClass, 
      x1 : ActionList*, 
      x2 : Cardinal*
    )

    fun call_action_proc = XtCallActionProc(
      x0 : Widget, 
      x1 : LibC::Char*, 
      x2 : XEvent*, 
      x3 : String*, 
    ...
    fun register_grab_action = XtRegisterGrabAction(
      x0 : ActionProc, 
      x1 : Boolean, 
      x2 : LibC::UInt, 
      x3 : LibC::Int, 
    ...
    fun get_action_keysym = XtGetActionKeysym(
      x0 : XEvent*, 
      x1 : Modifiers*
    ) : KeySym
    ...
    fun translate_keycode = XtTranslateKeycode(
      x0 : Display, 
      x1 : KeyCode, 
      x2 : Modifiers, 
      x3 : Modifiers*, 
    ...
    fun translate_key = XtTranslateKey(
      x0 : Display, 
      x1 : KeyCode, 
      x2 : Modifiers, 
      x3 : Modifiers*, 
    ...
    fun register_case_converter = XtRegisterCaseConverter(
      x0 : Display, 
      x1 : CaseProc, 
      x2 : KeySym, 
      x3 : KeySym
    ...
    fun convert_case = XtConvertCase(
      x0 : Display, 
      x1 : KeySym, 
      x2 : KeySym*, 
      x3 : KeySym*
    ...
    fun add_event_handler = XtAddEventHandler(
      x0 : Widget, 
      x1 : EventMask, 
      x2 : Boolean, 
      x3 : EventHandler, 
    ...
    fun remove_event_handler = XtRemoveEventHandler(
      x0 : Widget, 
      x1 : EventMask, 
      x2 : Boolean, 
      x3 : EventHandler, 
    ...
    fun add_raw_event_handler = XtAddRawEventHandler(
      x0 : Widget, 
      x1 : EventMask, 
      x2 : Boolean, 
      x3 : EventHandler, 
    ...
    fun remove_raw_event_handler = XtRemoveRawEventHandler(
      x0 : Widget, 
      x1 : EventMask, 
      x2 : Boolean, 
      x3 : EventHandler, 
    ...
    fun insert_event_handler = XtInsertEventHandler(
      x0 : Widget, 
      x1 : EventMask, 
      x2 : Boolean, 
      x3 : EventHandler, 
    ...
    fun insert_raw_event_handler = XtInsertRawEventHandler(
      x0 : Widget, 
      x1 : EventMask, 
      x2 : Boolean, 
      x3 : EventHandler, 
    ...
    fun set_event_dispatcher = XtSetEventDispatcher(
      x0 : Display, 
      x1 : LibC::Int, 
      x2 : EventDispatchProc
    ) : EventDispatchProc

    alias EventDispatchProc = (XEvent* -> Boolean)

    fun dispatch_event_to_widget = XtDispatchEventToWidget(
      x0 : Widget, 
      x1 : XEvent*
    ) : Boolean

    fun insert_event_type_handler = XtInsertEventTypeHandler(
      x0 : Widget, 
      x1 : LibC::Int, 
      x2 : Pointer, 
      x3 : EventHandler, 
    ...
    fun remove_event_type_handler = XtRemoveEventTypeHandler(
      x0 : Widget, 
      x1 : LibC::Int, 
      x2 : Pointer, 
      x3 : EventHandler, 
    ...
    fun register_extension_selector = XtRegisterExtensionSelector(
      x0 : Display, 
      x1 : LibC::Int, 
      x2 : LibC::Int, 
      x3 : ExtensionSelectProc, 
      x4 : Pointer
    )

    alias ExtensionSelectProc = (
      Widget, 
      LibC::Int*, 
      Pointer*, 
      LibC::Int, 
    ...
    fun add_time_out = XtAddTimeOut(
      x0 : LibC::ULong, 
      x1 : TimerCallbackProc, 
      x2 : Pointer
    ) : IntervalId

    fun app_add_time_out = XtAppAddTimeOut(
      x0 : AppContext, 
      x1 : LibC::ULong, 
      x2 : TimerCallbackProc, 
      x3 : Pointer
    ) : IntervalId

    fun remove_time_out = XtRemoveTimeOut(x0 : IntervalId)

    fun add_input = XtAddInput(
      x0 : LibC::Int, 
      x1 : Pointer, 
      x2 : InputCallbackProc, 
      x3 : Pointer
    ) : InputId

    fun app_add_input = XtAppAddInput(
      x0 : AppContext, 
      x1 : LibC::Int, 
      x2 : Pointer, 
      x3 : InputCallbackProc, 
      x4 : Pointer
    ) : InputId

    fun remove_input = XtRemoveInput(x0 : InputId)

    fun add_signal = XtAddSignal(
      x0 : SignalCallbackProc, 
      x1 : Pointer
    ) : SignalId

    fun app_add_signal = XtAppAddSignal(
      x0 : AppContext, 
      x1 : SignalCallbackProc, 
      x2 : Pointer
    ) : SignalId
    ...
    fun app_add_block_hook = XtAppAddBlockHook(
      x0 : AppContext, 
      x1 : BlockHookProc, 
      x2 : Pointer
    ) : BlockHookId
    ...
    fun add_callback = XtAddCallback(
      x0 : Widget, 
      x1 : LibC::Char*, 
      x2 : CallbackProc, 
      x3 : Pointer
    ...
    fun remove_callback = XtRemoveCallback(
      x0 : Widget, 
      x1 : LibC::Char*, 
      x2 : CallbackProc, 
      x3 : Pointer
    ...
    fun add_callbacks = XtAddCallbacks(
      x0 : Widget, 
      x1 : LibC::Char*, 
      x2 : CallbackList
    )

    fun remove_callbacks = XtRemoveCallbacks(
      x0 : Widget, 
      x1 : LibC::Char*, 
      x2 : CallbackList
    )

    fun remove_all_callbacks = XtRemoveAllCallbacks(
      x0 : Widget, 
      x1 : LibC::Char*
    )

    fun call_callbacks = XtCallCallbacks(
      x0 : Widget, 
      x1 : LibC::Char*, 
      x2 : Pointer
    )

    fun call_callback_list = XtCallCallbackList(
      x0 : Widget, 
      x1 : CallbackList, 
      x2 : Pointer
    )

    fun has_callbacks = XtHasCallbacks(
      x0 : Widget, 
      x1 : LibC::Char*
    ) : CallbackStatus
    ...
    fun make_geometry_request = XtMakeGeometryRequest(
      x0 : Widget, 
      x1 : WidgetGeometry*, 
      x2 : WidgetGeometry*
    ) : GeometryResult
    
    fun query_geometry = XtQueryGeometry(
      x0 : Widget, 
      x1 : WidgetGeometry*, 
      x2 : WidgetGeometry*
    ) : GeometryResult
    
    fun create_popup_shell = XtCreatePopupShell(
      x0 : LibC::Char*, 
      x1 : WidgetClass, 
      x2 : Widget, 
      x3 : ArgList, 
    ...
    fun va_create_popup_shell = XtVaCreatePopupShell(
      x0 : LibC::Char*, 
      x1 : WidgetClass, 
      x2 : Widget, 
      ...
    ...
    fun callback_nonexclusive = XtCallbackNonexclusive(
      x0 : Widget, 
      x1 : Pointer, 
      x2 : Pointer
    )

    fun callback_exclusive = XtCallbackExclusive(
      x0 : Widget, 
      x1 : Pointer, 
      x2 : Pointer
    )
    ...
    fun callback_popdown = XtCallbackPopdown(
      x0 : Widget, 
      x1 : Pointer, 
      x2 : Pointer
    )

    fun menu_popup_action = XtMenuPopupAction(
      x0 : Widget, 
      x1 : XEvent*, 
      x2 : String*, 
      x3 : Cardinal*
    ...
    fun create_widget = XtCreateWidget(
      x0 : LibC::Char*, 
      x1 : WidgetClass, 
      x2 : Widget, 
      x3 : ArgList, 
    ...
    fun create_managed_widget = XtCreateManagedWidget(
      x0 : LibC::Char*, 
      x1 : WidgetClass, 
      x2 : Widget, 
      x3 : ArgList, 
    ...
    fun va_create_widget = XtVaCreateWidget(
      x0 : LibC::Char*, 
      x1 : WidgetClass, 
      x2 : Widget, 
      ...
    ...
    fun va_create_managed_widget = XtVaCreateManagedWidget(
      x0 : LibC::Char*, 
      x1 : WidgetClass, 
      x2 : Widget, 
      ...
    ...
    fun create_application_shell = XtCreateApplicationShell(
      x0 : LibC::Char*, 
      x1 : WidgetClass, 
      x2 : ArgList, 
      x3 : Cardinal
    ...
    fun app_create_shell = XtAppCreateShell(
      x0 : LibC::Char*, 
      x1 : LibC::Char*, 
      x2 : WidgetClass, 
      x3 : Display, 
    ...
    fun va_app_create_shell = XtVaAppCreateShell(
      x0 : LibC::Char*, 
      x1 : LibC::Char*, 
      x2 : WidgetClass, 
      x3 : Display, 
    ...
    fun set_language_proc = XtSetLanguageProc(
      x0 : AppContext, 
      x1 : LanguageProc, 
      x2 : Pointer
    ) : LanguageProc

    fun display_initialize = XtDisplayInitialize(
      x0 : AppContext, 
      x1 : Display, 
      x2 : LibC::Char*, 
      x3 : LibC::Char*, 
    ...
    fun open_application = XtOpenApplication(
      x0 : AppContext*, 
      x1 : LibC::Char*, 
      x2 : XrmOptionDescList, 
      x3 : Cardinal, 
      x4 : LibC::Int*, 
      x5 : String*, 
      x6 : String*, 
    ...
    fun va_open_application = XtVaOpenApplication(
      x0 : AppContext*, 
      x1 : LibC::Char*, 
      x2 : XrmOptionDescList, 
      x3 : Cardinal, 
    ...
    fun app_initialize = XtAppInitialize(
      x0 : AppContext*, 
      x1 : LibC::Char*, 
      x2 : XrmOptionDescList, 
      x3 : Cardinal, 
    ...
    fun va_app_initialize = XtVaAppInitialize(
      x0 : AppContext*, 
      x1 : LibC::Char*, 
      x2 : XrmOptionDescList, 
      x3 : Cardinal, 
    ...
    fun open_display = XtOpenDisplay(
      x0 : AppContext, 
      x1 : LibC::Char*, 
      x2 : LibC::Char*, 
      x3 : LibC::Char*, 
    ...
    fun app_set_fallback_resources = XtAppSetFallbackResources(
      x0 : AppContext, 
      x1 : String*
    )

    fun destroy_application_context = XtDestroyApplicationContext(
      x0 : AppContext
    )

    fun initialize_widget_class = XtInitializeWidgetClass(x0 : WidgetClass)

    fun widget_to_application_context = XtWidgetToApplicationContext(
      x0 : Widget
    ) : AppContext

    fun display_to_application_context = XtDisplayToApplicationContext(
      x0 : Display
    ) : AppContext
    ...
    fun get_application_resources = XtGetApplicationResources(
      x0 : Widget, 
      x1 : Pointer, 
      x2 : ResourceList, 
      x3 : Cardinal, 
    ...
    fun va_get_application_resources = XtVaGetApplicationResources(
      x0 : Widget, 
      x1 : Pointer, 
      x2 : ResourceList, 
      x3 : Cardinal, 
    ...
    fun get_subresources = XtGetSubresources(
      x0 : Widget, 
      x1 : Pointer, 
      x2 : LibC::Char*, 
      x3 : LibC::Char*, 
    ...
    fun va_get_subresources = XtVaGetSubresources(
      x0 : Widget, 
      x1 : Pointer, 
      x2 : LibC::Char*, 
      x3 : LibC::Char*, 
    ...
    fun set_subvalues = XtSetSubvalues(
      x0 : Pointer, 
      x1 : ResourceList, 
      x2 : Cardinal, 
      x3 : ArgList, 
    ...
    fun va_set_subvalues = XtVaSetSubvalues(
      x0 : Pointer, 
      x1 : ResourceList, 
      x2 : Cardinal, 
      ...
    ...
    fun get_subvalues = XtGetSubvalues(
      x0 : Pointer, 
      x1 : ResourceList, 
      x2 : Cardinal, 
      x3 : ArgList, 
    ...
    fun va_get_subvalues = XtVaGetSubvalues(
      x0 : Pointer, 
      x1 : ResourceList, 
      x2 : Cardinal, 
      ...
    ...
    fun get_resource_list = XtGetResourceList(
      x0 : WidgetClass, 
      x1 : ResourceList*, 
      x2 : Cardinal*
    )

    fun get_constraint_resource_list = XtGetConstraintResourceList(
      x0 : WidgetClass, 
      x1 : ResourceList*, 
      x2 : Cardinal*
    )
    ...
    fun app_set_error_msg_handler = XtAppSetErrorMsgHandler(
      x0 : AppContext, 
      x1 : ErrorMsgHandler
    ) : ErrorMsgHandler
    ...
    fun app_set_warning_msg_handler = XtAppSetWarningMsgHandler(
      x0 : AppContext, 
      x1 : ErrorMsgHandler
    ) : ErrorMsgHandler
    ...
    fun app_error_msg = XtAppErrorMsg(
      x0 : AppContext, 
      x1 : LibC::Char*, 
      x2 : LibC::Char*, 
      x3 : LibC::Char*, 
    ...
    fun app_warning_msg = XtAppWarningMsg(
      x0 : AppContext, 
      x1 : LibC::Char*, 
      x2 : LibC::Char*, 
      x3 : LibC::Char*, 
    ...
    fun app_set_error_handler = XtAppSetErrorHandler(
      x0 : AppContext, 
      x1 : ErrorHandler
    ) : ErrorHandler
    ...
    fun app_set_warning_handler = XtAppSetWarningHandler(
      x0 : AppContext, 
      x1 : ErrorHandler
    ) : ErrorHandler
    ...
    fun app_get_error_database = XtAppGetErrorDatabase(
      x0 : AppContext
    ) : XrmDatabase*

    fun get_error_database = XtGetErrorDatabase : XrmDatabase*

    fun app_get_error_database_text = XtAppGetErrorDatabaseText(
      x0 : AppContext, 
      x1 : LibC::Char*, 
      x2 : LibC::Char*, 
      x3 : LibC::Char*, 
    ...
    fun get_error_database_text = XtGetErrorDatabaseText(
      x0 : LibC::Char*, 
      x1 : LibC::Char*, 
      x2 : LibC::Char*, 
      x3 : LibC::Char*, 
    ...
    fun app_add_work_proc = XtAppAddWorkProc(
      x0 : AppContext, 
      x1 : WorkProc, 
      x2 : Pointer
    ) : WorkProcId
    ...
    fun app_release_cache_refs = XtAppReleaseCacheRefs(
      x0 : AppContext, 
      x1 : CacheRef*
    )

    fun callback_release_cache_ref = XtCallbackReleaseCacheRef(
      x0 : Widget, 
      x1 : Pointer, 
      x2 : Pointer
    )

    fun callback_release_cache_ref_list = XtCallbackReleaseCacheRefList(
      x0 : Widget, 
      x1 : Pointer, 
      x2 : Pointer
    )

    fun set_wm_colormap_windows = XtSetWMColormapWindows(
      x0 : Widget, 
      x1 : Widget*, 
      x2 : Cardinal
    )

    fun find_file = XtFindFile(
      x0 : LibC::Char*, 
      x1 : Substitution, 
      x2 : Cardinal, 
      x3 : FilePredicate
    ...
    fun resolve_pathname = XtResolvePathname(
      x0 : Display, 
      x1 : LibC::Char*, 
      x2 : LibC::Char*, 
      x3 : LibC::Char*, 
    ...
    fun get_selection_value = XtGetSelectionValue(
      x0 : Widget, 
      x1 : Atom, 
      x2 : Atom, 
      x3 : SelectionCallbackProc, 
      x4 : Pointer, 
      x5 : Time
    )

    alias SelectionCallbackProc = (
      Widget, 
      Pointer, 
      Atom*, 
      Atom*, 
    ...
    fun get_selection_values = XtGetSelectionValues(
      ...
      x2 : Atom*, 
      x3 : LibC::Int, 
      x4 : SelectionCallbackProc, 
      x5 : Pointer*, 
      x6 : Time
    )

    fun app_set_selection_timeout = XtAppSetSelectionTimeout(
      x0 : AppContext, 
      x1 : LibC::ULong
    )
    ...
    fun app_get_selection_timeout = XtAppGetSelectionTimeout(
      x0 : AppContext
    ) : LibC::ULong

    fun get_selection_timeout = XtGetSelectionTimeout : LibC::ULong

    fun get_selection_request = XtGetSelectionRequest(
      x0 : Widget, 
      x1 : Atom, 
      x2 : RequestId
    ) : XSelectionRequestEvent*

    fun get_selection_value_incremental = XtGetSelectionValueIncremental(
      x0 : Widget, 
      x1 : Atom, 
      x2 : Atom, 
      x3 : SelectionCallbackProc, 
    ...
    fun get_selection_values_incremental = XtGetSelectionValuesIncremental(
      x0 : Widget, 
      x1 : Atom, 
      x2 : Atom*, 
      x3 : LibC::Int, 
    ...
    fun set_selection_parameters = XtSetSelectionParameters(
      x0 : Widget, 
      x1 : Atom, 
      x2 : Atom, 
      x3 : Pointer, 
    ...
    fun get_selection_parameters = XtGetSelectionParameters(
      x0 : Widget, 
      x1 : Atom, 
      x2 : RequestId, 
      x3 : Atom*, 
    ...
    fun create_selection_request = XtCreateSelectionRequest(
      x0 : Widget, 
      x1 : Atom
    )

    fun send_selection_request = XtSendSelectionRequest(
      x0 : Widget, 
      x1 : Atom, 
      x2 : Time
    )

    fun cancel_selection_request = XtCancelSelectionRequest(
      x0 : Widget, 
      x1 : Atom
    )
    ...
    fun grab_keyboard = XtGrabKeyboard(
      x0 : Widget, 
      x1 : Boolean, 
      x2 : LibC::Int, 
      x3 : LibC::Int, 
    ...
    fun ungrab_button = XtUngrabButton(
      x0 : Widget, 
      x1 : LibC::UInt, 
      x2 : Modifiers
    )

    fun grab_pointer = XtGrabPointer(
      x0 : Widget, 
      x1 : Boolean, 
      x2 : LibC::UInt, 
      x3 : LibC::Int, 
    ...
    fun get_application_name_and_class = XtGetApplicationNameAndClass(
      x0 : Display, 
      x1 : String*, 
      x2 : String*
    )

    fun register_drawable = XtRegisterDrawable(
      x0 : Display, 
      x1 : Drawable, 
      x2 : Widget
    )
    ...
    fun cvt_string_to_accelerator_table = XtCvtStringToAcceleratorTable(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_atom = XtCvtStringToAtom(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_bool = XtCvtStringToBool(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_boolean = XtCvtStringToBoolean(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_command_arg_array = XtCvtStringToCommandArgArray(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_cursor = XtCvtStringToCursor(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_dimension = XtCvtStringToDimension(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_directory_string = XtCvtStringToDirectoryString(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_display = XtCvtStringToDisplay(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_file = XtCvtStringToFile(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_float = XtCvtStringToFloat(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_font = XtCvtStringToFont(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_font_set = XtCvtStringToFontSet(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_font_struct = XtCvtStringToFontStruct(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_gravity = XtCvtStringToGravity(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_initial_state = XtCvtStringToInitialState(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_int = XtCvtStringToInt(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_pixel = XtCvtStringToPixel(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_restart_style = XtCvtStringToRestartStyle(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr,
    ...
    fun cvt_string_to_short = XtCvtStringToShort(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_translation_table = XtCvtStringToTranslationTable(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_unsigned_char = XtCvtStringToUnsignedChar(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_string_to_visual = XtCvtStringToVisual(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_int_to_bool = XtCvtIntToBool(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_int_to_boolean = XtCvtIntToBoolean(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_int_to_color = XtCvtIntToColor(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_int_to_float = XtCvtIntToFloat(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_int_to_font = XtCvtIntToFont(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_int_to_pixel = XtCvtIntToPixel(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_int_to_pixmap = XtCvtIntToPixmap(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_int_to_short = XtCvtIntToShort(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_int_to_unsigned_char = XtCvtIntToUnsignedChar(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun cvt_color_to_pixel = XtCvtColorToPixel(
      x0 : Display, 
      x1 : XrmValuePtr, 
      x2 : Cardinal*, 
      x3 : XrmValuePtr, 
    ...
    fun create_window = XtCreateWindow(
      x0 : Widget, 
      x1 : LibC::UInt, 
      x2 : Visual*, 
      x3 : ValueMask, 
      x4 : XSetWindowAttributes*
    )

    fun resize_widget = XtResizeWidget(
      x0 : Widget, 
      x1 : Dimension, 
      x2 : Dimension, 
      x3 : Dimension
    ...
    fun configure_widget = XtConfigureWidget(
      x0 : Widget, 
      x1 : Position, 
      x2 : Position, 
      x3 : Dimension, 
